...
if (isset($_POST['submit'])) {
    ...
    $r = $conn->query($sql); //0
    if ($r) {
        $_SESSION['success_msg'] = "Thanks for Registration !! ";
    } else {
...
<div class="form">
    ...
    <ul class="tab-group text-center">
        <li class="tab active"><a href="#signup" class="btn btn-primary">Sign Up</a></li>
        <br>
        <li class="tab"><a href="#login" class="btn btn-primary">Log In</a></li>
    </ul>
    ...
    <div class="tab-content">
        <div id="signup">
            ...
            ?>
            <form method="POST" enctype="multipart/form-data" autocomplete="off" action="signup.php">
